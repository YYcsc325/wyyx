...
! function () {
    ...
    ysf.product = function () {
        var e = function (e) {
            ...
            if (e.tags && util.isArray(e.tags)) return {
                title: e.title,
                desc: e.desc,
                picture: e.picture,
                url: e.url,
